...
from .views import BlogView, BlogPostView, AddBlogPostView, UpdateBlogPost, DeleteBlogView, AddCategoryView, CategoryView, AddCommentView, LikeView
...
urlpatterns = [
    ...
    path('blog_like/<int:pk>', LikeView, name ='like_post'),
]